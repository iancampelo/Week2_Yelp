...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Float?, offset: Int?, completion: @escaping ([Business]?, NSError?) -> Void) -> AFHTTPRequestOperation {
        // For additional parameters, see http://www.yelp.com/developers/documentation/v2/search_api
        ...
        if distance != nil {
            ...
            parameters["radius_filter"] = distance!/milesPerMeter as AnyObject?
        }
